...
**STATUS**: 4/10 Complete, 1 Active (P1), 5 Deferred (P2/P3)
...
| 5 | MAINT-3 | Implement test coverage Phase 1 | Backlog | Code | DOC-5 policy | | | | docs/spec-kit/testing-policy.md | **Problem**: 1.7% coverage (178/7,883 LOC), policy targets 40% by Q1 2026. Phase 1 (Nov 2025): Infrastructure. **Fix**: Implement MockMcpManager, create fixture library (20 agent outputs), setup cargo tarpaulin. **Acceptance**: MockMcpManager works, 20 fixtures extracted, tarpaulin reports 1.7% baseline. **Effort**: 2 weeks (L). |
