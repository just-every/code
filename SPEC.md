...
| 16 | T18 | HAL HTTP MCP integration | In Progress | Code | docs/SPEC-KIT-018-hal-http-mcp/spec.md |  |  | 2025-09-28 | docs/SPEC-OPS-004-integrated-coder-hooks/evidence/commands/SPEC-KIT-018/20250928-185933Z-hal-health.json | HAL smoke JSON (health/list/indexer/graphql) captured; `cargo test -p codex-tui spec_auto` |
