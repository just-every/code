...
pub(crate) struct Session {
    ...
    pub(super) hooks_settings: crate::config_types::HooksSettings,
    pub(super) hooks_model_provider_id: String,
    pub(super) hooks_model_provider: ModelProviderInfo,
    pub(super) hooks_client: Option<ModelClient>,
