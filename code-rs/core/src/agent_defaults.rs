...
const AGENT_MODEL_SPECS: &[AgentModelSpec] = &[
    ...
    AgentModelSpec {
        ...
        description: "Flagship coding agent. Use when you want maximum reasoning depth and fidelity; falls back to this when older code-gpt-5.1-codex is requested.",
        enabled_by_default: true,
