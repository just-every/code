...
const AGENT_MODEL_SPECS: &[AgentModelSpec] = &[
    ...
    AgentModelSpec {
        ...
        description: "Frontline coding agent for moderate to challenging work; maximum reasoning depth with tuned fast mode (higher cost). Falls back for legacy codex requests.",
        enabled_by_default: true,
    ...
    AgentModelSpec {
        ...
        description: "Mixed tasks that blend code with design/product reasoning; balances speed and breadth.",
        enabled_by_default: true,
